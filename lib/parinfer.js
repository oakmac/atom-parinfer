...
cljs.core.nil_iter = function cljs$core$nil_iter() {
  "undefined" === typeof cljs.core.t_cljs$core8047 && (cljs.core.t_cljs$core8047 = function(b, c) {
    this.nil_iter = b;
    this.meta8048 = c;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
    this.cljs$lang$protocol_mask$partition1$ = 0;
  }, cljs.core.t_cljs$core8047.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t_cljs$core8047(this.nil_iter, c);
  }, cljs.core.t_cljs$core8047.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta8048;
  }, cljs.core.t_cljs$core8047.prototype.hasNext = function() {
    return !1;
  }, cljs.core.t_cljs$core8047.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t_cljs$core8047.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t_cljs$core8047.getBasis = function() {
    return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null, "nil-iter", "nil-iter", 1101030523, null), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "arglists", "arglists", 1661989754), cljs.core.list(new cljs.core.Symbol(null, "quote", "quote", 1377916282, null), cljs.core.list(cljs.core.PersistentVector.EMPTY))], null)), new cljs.core.Symbol(null, "meta8048", "meta8048", -1504667211, null)], 
    null);
  }, cljs.core.t_cljs$core8047.cljs$lang$type = !0, cljs.core.t_cljs$core8047.cljs$lang$ctorStr = "cljs.core/t_cljs$core8047", cljs.core.t_cljs$core8047.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write(c, "cljs.core/t_cljs$core8047");
  }, cljs.core.__GT_t_cljs$core8047 = function(b, c) {
    return new cljs.core.t_cljs$core8047(b, c);
  });
  return new cljs.core.t_cljs$core8047(cljs$core$nil_iter, cljs.core.PersistentArrayMap.EMPTY);
};
...
var parinfer_lib = {reader:{}};
parinfer_lib.reader.matching_delim = new cljs.core.PersistentArrayMap(null, 6, "{}}{[]][())(".split(""), null);
parinfer_lib.reader.opening_delim_QMARK_ = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["(", null, "{", null, "[", null], null), null);
parinfer_lib.reader.closing_delim_QMARK_ = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["]", null, ")", null, "}", null], null), null);
parinfer_lib.reader.whitespace_QMARK_ = function(a) {
  return cljs.core.re_find.call(null, /[\s,]/, a);
};
parinfer_lib.reader.prev_ch = function(a) {
  return (new cljs.core.Keyword(null, "ch", "ch", -554717905)).cljs$core$IFn$_invoke$arity$1(cljs.core.peek.call(null, a));
};
parinfer_lib.reader.escaping_QMARK_ = function(a) {
  return cljs.core._EQ_.call(null, "\\", parinfer_lib.reader.prev_ch.call(null, a));
};
parinfer_lib.reader.in_str_QMARK_ = function(a) {
  a = parinfer_lib.reader.prev_ch.call(null, cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, a)) ? cljs.core.pop.call(null, a) : a);
  return cljs.core._EQ_.call(null, '"', a);
};
parinfer_lib.reader.in_comment_QMARK_ = function(a) {
  return cljs.core._EQ_.call(null, ";", parinfer_lib.reader.prev_ch.call(null, a));
};
parinfer_lib.reader.in_code_QMARK_ = function(a) {
  return cljs.core.not.call(null, parinfer_lib.reader.in_str_QMARK_.call(null, a)) && cljs.core.not.call(null, parinfer_lib.reader.in_comment_QMARK_.call(null, a));
};
parinfer_lib.reader.valid_closer_QMARK_ = function(a, b) {
  return cljs.core._EQ_.call(null, parinfer_lib.reader.prev_ch.call(null, a), parinfer_lib.reader.matching_delim.call(null, b));
};
"undefined" === typeof parinfer_lib.reader.push_char_STAR_ && (parinfer_lib.reader.push_char_STAR_ = function() {
  ...
  return new cljs.core.MultiFn(cljs.core.symbol.call(null, "parinfer-lib.reader", "push-char*"), function(a, b, c, d, e) {
    return function(a) {
      a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
      a = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "ch", "ch", -554717905));
      return cljs.core.truth_(parinfer_lib.reader.opening_delim_QMARK_.call(null, a)) ? new cljs.core.Keyword(null, "open", "open", -1763596448) : cljs.core.truth_(parinfer_lib.reader.closing_delim_QMARK_.call(null, a)) ? new cljs.core.Keyword(null, "close", "close", 1835149582) : a;
    };
  }(a, b, c, d, e), new cljs.core.Keyword(null, "default", "default", -1987822328), e, a, b, c, d);
}());
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, "\t", function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  a = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  return cljs.core.not.call(null, parinfer_lib.reader.in_str_QMARK_.call(null, a)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "ch", "ch", -554717905), "  "], null) : null;
});
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, new cljs.core.Keyword(null, "open", "open", -1763596448), function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  return cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, b)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.pop.call(null, b)], null) : cljs.core.truth_(parinfer_lib.reader.in_code_QMARK_.call(null, b)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.conj.call(null, b, cljs.core.select_keys.call(null, a, new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, 
  [new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), new cljs.core.Keyword(null, "ch", "ch", -554717905), new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232)], null)))], null) : null;
});
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, new cljs.core.Keyword(null, "close", "close", 1835149582), function(a) {
  var b = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  a = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  var c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "backup", "backup", 26347393)), b = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "ch", "ch", -554717905));
  return cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, a)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.pop.call(null, a)], null) : cljs.core.truth_(parinfer_lib.reader.in_code_QMARK_.call(null, a)) ? cljs.core.truth_(parinfer_lib.reader.valid_closer_QMARK_.call(null, a, b)) ? (b = cljs.core.peek.call(null, a), new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "stack", "stack", -793405930), 
  cljs.core.pop.call(null, a), new cljs.core.Keyword(null, "backup", "backup", 26347393), cljs.core.conj.call(null, c, b)], null)) : new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "ch", "ch", -554717905), ""], null) : null;
});
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, ";", function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  return cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, b)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.pop.call(null, b)], null) : cljs.core.truth_(parinfer_lib.reader.in_code_QMARK_.call(null, b)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.conj.call(null, b, cljs.core.select_keys.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, 
  [new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), new cljs.core.Keyword(null, "ch", "ch", -554717905)], null)))], null) : null;
});
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, "\n", function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  a = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  a = cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, a)) ? cljs.core.pop.call(null, a) : a;
  a = cljs.core.truth_(parinfer_lib.reader.in_comment_QMARK_.call(null, a)) ? cljs.core.pop.call(null, a) : a;
  return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "ch", "ch", -554717905), "", new cljs.core.Keyword(null, "stack", "stack", -793405930), a], null);
});
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, "\\", function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  return cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, b)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.pop.call(null, b)], null) : cljs.core.truth_(parinfer_lib.reader.in_comment_QMARK_.call(null, b)) ? null : new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.conj.call(null, b, cljs.core.select_keys.call(null, a, new cljs.core.PersistentVector(null, 
  2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), new cljs.core.Keyword(null, "ch", "ch", -554717905)], null)))], null);
});
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, '"', function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  return cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, b)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.pop.call(null, b)], null) : cljs.core.truth_(parinfer_lib.reader.in_str_QMARK_.call(null, b)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.pop.call(null, b)], null) : cljs.core.truth_(parinfer_lib.reader.in_comment_QMARK_.call(null, b)) ? null : 
  new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.conj.call(null, b, cljs.core.select_keys.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), new cljs.core.Keyword(null, "ch", "ch", -554717905)], null)))], null);
});
cljs.core._add_method.call(null, parinfer_lib.reader.push_char_STAR_, new cljs.core.Keyword(null, "default", "default", -1987822328), function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  a = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  return cljs.core.truth_(parinfer_lib.reader.escaping_QMARK_.call(null, a)) ? new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "stack", "stack", -793405930), cljs.core.pop.call(null, a)], null) : null;
});
parinfer_lib.reader.push_char = function(a) {
  var b = parinfer_lib.reader.push_char_STAR_.call(null, a);
  return cljs.core.merge_with.call(null, function(a) {
    return function(a, b) {
      return cljs.core.truth_(b) ? b : a;
    };
  }(b), a, b);
...
parinfer_lib.string = {};
parinfer_lib.string.insert_string = function(a, b, c) {
  return [cljs.core.str(cljs.core.subs.call(null, a, 0, b)), cljs.core.str(c), cljs.core.str(cljs.core.subs.call(null, a, b))].join("");
};
parinfer_lib.string.remove_str_range = function(a, b, c) {
  return [cljs.core.str(cljs.core.subs.call(null, a, 0, b)), cljs.core.str(cljs.core.subs.call(null, a, c))].join("");
};
parinfer_lib.string.get_lines = function(a) {
  return clojure.string.split.call(null, a, /\n/, -1);
};
parinfer_lib.infer = {};
parinfer_lib.infer.initial_state = cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728), new cljs.core.Keyword(null, "backup", "backup", 26347393), new cljs.core.Keyword(null, "insert", "insert", 1286475395), new cljs.core.Keyword(null, "lines", "lines", -700165781), new cljs.core.Keyword(null, "postline-states", "postline-states", 1667653678), new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136), new cljs.core.Keyword(null, 
"line-no", "line-no", -666819466), new cljs.core.Keyword(null, "stack", "stack", -793405930), new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762)], [cljs.core.PersistentVector.EMPTY, cljs.core.PersistentVector.EMPTY, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486), null, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), null], null), cljs.core.PersistentVector.EMPTY, cljs.core.PersistentVector.EMPTY, !1, -1, cljs.core.PersistentVector.EMPTY, 
new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "start", "start", -355208981), null, new cljs.core.Keyword(null, "end", "end", -268185958), null], null)]);
parinfer_lib.infer.close_delims = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.infer.close_delims.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.infer.close_delims.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.infer.close_delims.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.infer.close_delims.call(null, a, 0);
};
parinfer_lib.infer.close_delims.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c;
  a: {
    var d = (new cljs.core.Keyword(null, "stack", "stack", -793405930)).cljs$core$IFn$_invoke$arity$1(a);
    for (c = "";;) {
      if (cljs.core.not.call(null, cljs.core.seq.call(null, d))) {
        c = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [d, c], null);
        break a;
      } else {
        var e = cljs.core.peek.call(null, d), f = null != e && (e.cljs$lang$protocol_mask$partition0$ & 64 || e.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, e) : e, e = cljs.core.get.call(null, f, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)), f = cljs.core.get.call(null, f, new cljs.core.Keyword(null, "ch", "ch", -554717905));
        if (e >= b) {
          d = cljs.core.pop.call(null, d), c = [cljs.core.str(c), cljs.core.str(parinfer_lib.reader.matching_delim.call(null, f))].join("");
        } else {
          c = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [d, c], null);
          break a;
        }
  ...
  e = (new cljs.core.Keyword(null, "insert", "insert", 1286475395)).cljs$core$IFn$_invoke$arity$1(a);
  f = null != e && (e.cljs$lang$protocol_mask$partition0$ & 64 || e.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, e) : e;
  e = cljs.core.get.call(null, f, new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486));
  f = cljs.core.get.call(null, f, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783));
  e = (new cljs.core.Keyword(null, "line-no", "line-no", -666819466)).cljs$core$IFn$_invoke$arity$1(a) + e;
  return cljs.core.assoc.call(null, cljs.core.update_in.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "lines", "lines", -700165781), e], null), parinfer_lib.string.insert_string, f, c), new cljs.core.Keyword(null, "stack", "stack", -793405930), d);
};
parinfer_lib.infer.close_delims.cljs$lang$maxFixedArity = 2;
parinfer_lib.infer.update_delim_trail = function(a) {
  var b = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "stack", "stack", -793405930)), d = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762)), e = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "backup", "backup", 26347393)), f = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "x-pos", 
  "x-pos", -382213783)), g = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "ch", "ch", -554717905)), h = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "cursor-line", "cursor-line", -1089611007)), k = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), l = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "cursor-x", "cursor-x", 475204266)), m = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "cursor-in-comment?", "cursor-in-comment?", 
  1676951135)), n = function() {
    var a = cljs.core._EQ_.call(null, ";", g);
    if (a) {
      return a;
    }
    a = parinfer_lib.reader.whitespace_QMARK_.call(null, g);
    return cljs.core.truth_(a) ? a : parinfer_lib.reader.closing_delim_QMARK_.call(null, g);
  }(), p = cljs.core.truth_(parinfer_lib.reader.in_code_QMARK_.call(null, c)) ? function() {
    var a = parinfer_lib.reader.escaping_QMARK_.call(null, c);
    return cljs.core.truth_(a) ? a : cljs.core.not.call(null, n);
  }() : null, q = function() {
    if (cljs.core.truth_(m)) {
      return m;
    }
    var a = cljs.core._EQ_.call(null, h, k);
    return a ? (a = cljs.core._EQ_.call(null, f, l)) ? parinfer_lib.reader.in_comment_QMARK_.call(null, c) : a : a;
  }(), r = function() {
    var a = parinfer_lib.reader.in_code_QMARK_.call(null, c);
    return cljs.core.truth_(a) && (a = cljs.core.not.call(null, parinfer_lib.reader.escaping_QMARK_.call(null, c))) ? (a = parinfer_lib.reader.closing_delim_QMARK_.call(null, g), cljs.core.truth_(a) ? parinfer_lib.reader.valid_closer_QMARK_.call(null, c, g) : a) : a;
  }(), t = cljs.core.truth_(p) ? cljs.core.empty.call(null, e) : e;
  a = cljs.core.truth_(p) ? cljs.core.PersistentArrayMap.EMPTY : cljs.core.truth_(r) ? cljs.core.assoc.call(null, cljs.core.update_in.call(null, d, new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "start", "start", -355208981)], null), function(a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, t, I) {
    return function(a) {
      return cljs.core.truth_(a) ? a : n;
    };
  }(n, p, q, r, t, a, b, b, c, d, e, f, g, h, k, l, m)), new cljs.core.Keyword(null, "end", "end", -268185958), f + 1) : d;
  return cljs.core.assoc.call(null, b, new cljs.core.Keyword(null, "cursor-in-comment?", "cursor-in-comment?", 1676951135), q, new cljs.core.Keyword(null, "backup", "backup", 26347393), t, new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762), a);
};
parinfer_lib.infer.block_delim_trail = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), d = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "cursor-line", "cursor-line", -1089611007)), e = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "cursor-x", "cursor-x", 475204266)), f = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "cursor-in-comment?", "cursor-in-comment?", 
  1676951135)), g = null != b && (b.cljs$lang$protocol_mask$partition0$ & 64 || b.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, b = cljs.core.get.call(null, g, new cljs.core.Keyword(null, "start", "start", -355208981)), g = cljs.core.get.call(null, g, new cljs.core.Keyword(null, "end", "end", -268185958)), f = (c = cljs.core._EQ_.call(null, c, d)) ? cljs.core.truth_(b) ? e > b && cljs.core.not.call(null, f) : b : c, b = cljs.core.truth_(cljs.core.truth_(b) ? f : b) ? b > 
  e ? b : e : b, e = cljs.core.truth_(cljs.core.truth_(g) ? f : g) ? g > e ? g : e : g, f = cljs.core._EQ_.call(null, b, e) ? null : new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [b, e], null), e = cljs.core.nth.call(null, f, 0, null), f = cljs.core.nth.call(null, f, 1, null);
  return cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762), new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "start", "start", -355208981), e, new cljs.core.Keyword(null, "end", "end", -268185958), f], null));
};
parinfer_lib.infer.remove_delim_trail = function(a) {
  var b = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762));
  a = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "insert", "insert", 1286475395));
  var d = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), e = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "lines", "lines", -700165781)), f = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "backup", "backup", 26347393)), g = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "stack", "stack", -793405930)), h = null != c && (c.cljs$lang$protocol_mask$partition0$ & 64 || c.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, 
  c) : c, c = cljs.core.get.call(null, h, new cljs.core.Keyword(null, "start", "start", -355208981)), h = cljs.core.get.call(null, h, new cljs.core.Keyword(null, "end", "end", -268185958));
  if (cljs.core.truth_(cljs.core.truth_(c) ? h : c)) {
    var e = cljs.core.get.call(null, e, d), e = cljs.core.filter.call(null, parinfer_lib.reader.closing_delim_QMARK_, cljs.core.map.call(null, cljs.core.str, cljs.core.subs.call(null, e, c, h))), k = cljs.core.count.call(null, e), k = cljs.core.count.call(null, f) - k;
    a: {
      for (var l = g;;) {
        if (cljs.core._EQ_.call(null, k, cljs.core.count.call(null, f))) {
          f = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [f, l], null);
          break a;
        }
        g = cljs.core.pop.call(null, f);
        l = cljs.core.conj.call(null, l, cljs.core.peek.call(null, f));
        f = g;
      }
    }
    g = cljs.core.nth.call(null, f, 0, null);
    f = cljs.core.nth.call(null, f, 1, null);
    b = cljs.core.assoc.call(null, cljs.core.update_in.call(null, b, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "lines", "lines", -700165781), d], null), parinfer_lib.string.remove_str_range, c, h), new cljs.core.Keyword(null, "backup", "backup", 26347393), g, new cljs.core.Keyword(null, "stack", "stack", -793405930), f, new cljs.core.Keyword(null, "removed-delims", "removed-delims", 137127226), e);
    return 0 === (new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486)).cljs$core$IFn$_invoke$arity$1(a) ? cljs.core.update_in.call(null, b, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "insert", "insert", 1286475395), new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)], null), cljs.core.min, c) : b;
  }
  return b;
};
parinfer_lib.infer.update_insertion_pt = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  cljs.core.get.call(null, a, new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136));
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "cursor-line", "cursor-line", -1089611007)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "lines", "lines", -700165781)), d = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), e = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930)), f = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)), g = cljs.core.get.call(null, 
  a, new cljs.core.Keyword(null, "ch", "ch", -554717905)), c = "" + cljs.core.str(cljs.core.last.call(null, cljs.core.get.call(null, c, d)));
  e = parinfer_lib.reader.in_code_QMARK_.call(null, e);
  b = cljs.core.truth_(e) ? cljs.core.not_EQ_.call(null, "", g) && (cljs.core.not.call(null, parinfer_lib.reader.whitespace_QMARK_.call(null, g)) || cljs.core._EQ_.call(null, "\\", c)) && (cljs.core.not.call(null, parinfer_lib.reader.closing_delim_QMARK_.call(null, g)) || cljs.core._EQ_.call(null, d, b)) : e;
  f = cljs.core.truth_(b) ? new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486), 0, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), f + 1], null) : null;
  return cljs.core.truth_(f) ? cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "insert", "insert", 1286475395), f) : a;
};
parinfer_lib.infer.get_cached_state = function(a) {
  return cljs.core.select_keys.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "stack", "stack", -793405930), new cljs.core.Keyword(null, "insert", "insert", 1286475395)], null));
};
parinfer_lib.infer.commit_cached_state = function(a, b) {
  return cljs.core.update.call(null, a, b, cljs.core.conj, parinfer_lib.infer.get_cached_state.call(null, a));
};
parinfer_lib.infer.process_indent = function(a) {
  var b = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "stack", "stack", -793405930)), d = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "lines", "lines", -700165781));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "line-no", "line-no", -666819466));
  a = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783));
  var e = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "ch", "ch", -554717905));
  cljs.core.truth_(d) ? (c = parinfer_lib.reader.in_code_QMARK_.call(null, c), c = cljs.core.truth_(c) ? cljs.core.not.call(null, parinfer_lib.reader.whitespace_QMARK_.call(null, e)) && cljs.core.not_EQ_.call(null, ";", e) : c) : c = d;
  e = cljs.core.truth_(c) ? parinfer_lib.reader.closing_delim_QMARK_.call(null, e) : c;
  c = cljs.core.truth_(c) ? cljs.core.not.call(null, e) : c;
  b = cljs.core.assoc.call(null, b, new cljs.core.Keyword(null, "process?", "process?", -106844121), cljs.core.not.call(null, e));
  return cljs.core.truth_(c) ? cljs.core.assoc.call(null, parinfer_lib.infer.commit_cached_state.call(null, parinfer_lib.infer.close_delims.call(null, b, a), new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728)), new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136), !1, new cljs.core.Keyword(null, "processed-indent?", "processed-indent?", 526120923), !0) : b;
};
parinfer_lib.infer.update_line = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "ch", "ch", -554717905)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466));
  return cljs.core.update_in.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "lines", "lines", -700165781), c], null), cljs.core.str, b);
};
parinfer_lib.infer.save_preinsert_line = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "insert", "insert", 1286475395)), d = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "lines", "lines", -700165781));
  return cljs.core._EQ_.call(null, 0, (new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486)).cljs$core$IFn$_invoke$arity$1(c)) ? cljs.core.assoc_in.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "insert", "insert", 1286475395), new cljs.core.Keyword(null, "line", "line", 212345235)], null), cljs.core.get.call(null, d, b)) : a;
};
parinfer_lib.infer.process_char_STAR_ = function(a) {
  return parinfer_lib.infer.update_line.call(null, parinfer_lib.infer.update_insertion_pt.call(null, parinfer_lib.reader.push_char.call(null, parinfer_lib.infer.update_delim_trail.call(null, a))));
};
parinfer_lib.infer.process_char = function(a, b) {
  var c = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "lines", "lines", -700165781)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), d = cljs.core.count.call(null, cljs.core.get.call(null, d, e)), c = cljs.core.assoc.call(null, c, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), d, new cljs.core.Keyword(null, 
  "ch", "ch", -554717905), "" + cljs.core.str(b)), c = parinfer_lib.infer.process_indent.call(null, c);
  return cljs.core.truth_((new cljs.core.Keyword(null, "process?", "process?", -106844121)).cljs$core$IFn$_invoke$arity$1(c)) ? parinfer_lib.infer.process_char_STAR_.call(null, c) : c;
};
parinfer_lib.infer.process_line = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.infer.process_line.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.infer.process_line.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.infer.process_line.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.infer.process_line.call(null, parinfer_lib.infer.initial_state, a);
};
parinfer_lib.infer.process_line.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "stack", "stack", -793405930)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "lines", "lines", -700165781)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "cursor-line", 
  "cursor-line", -1089611007)), h = f + 1, k = cljs.core.assoc.call(null, c, new cljs.core.Keyword(null, "backup", "backup", 26347393), cljs.core.PersistentVector.EMPTY, new cljs.core.Keyword(null, "cursor-in-comment?", "cursor-in-comment?", 1676951135), !1, new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762), new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "start", "start", -355208981), null, new cljs.core.Keyword(null, "end", "end", -268185958), null], 
  null), new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136), cljs.core.seq.call(null, d) && cljs.core.not.call(null, parinfer_lib.reader.in_str_QMARK_.call(null, d)), new cljs.core.Keyword(null, "processed-indent?", "processed-indent?", 526120923), !1, new cljs.core.Keyword(null, "lines", "lines", -700165781), cljs.core.conj.call(null, e, ""), new cljs.core.Keyword(null, "line-no", "line-no", -666819466), h, new cljs.core.Keyword(null, "removed-delims", "removed-delims", 137127226), 
  cljs.core.PersistentVector.EMPTY), c = cljs.core.update_in.call(null, k, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "insert", "insert", 1286475395), new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486)], null), function(a, b, c, d, e, f, g, h, k) {
    return function(a) {
      return cljs.core.truth_(a) ? a - 1 : null;
    };
  }(h, k, a, c, c, d, e, f, g)), c = cljs.core.reduce.call(null, parinfer_lib.infer.process_char, c, [cljs.core.str(b), cljs.core.str("\n")].join("")), c = parinfer_lib.infer.commit_cached_state.call(null, parinfer_lib.infer.save_preinsert_line.call(null, parinfer_lib.infer.remove_delim_trail.call(null, parinfer_lib.infer.block_delim_trail.call(null, c))), new cljs.core.Keyword(null, "postline-states", "postline-states", 1667653678));
  return cljs.core.not.call(null, (new cljs.core.Keyword(null, "processed-indent?", "processed-indent?", 526120923)).cljs$core$IFn$_invoke$arity$1(c)) ? cljs.core.update.call(null, c, new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728), cljs.core.conj, null) : c;
};
parinfer_lib.infer.process_line.cljs$lang$maxFixedArity = 2;
parinfer_lib.infer.finalize_state = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930)), c = cljs.core.not.call(null, parinfer_lib.reader.in_str_QMARK_.call(null, b)), b = c && cljs.core.seq.call(null, b);
  a = cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "valid?", "valid?", -212412379), c);
  return b ? parinfer_lib.infer.close_delims.call(null, a) : a;
};
parinfer_lib.infer.process_text = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.infer.process_text.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.infer.process_text.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.infer.process_text.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.infer.process_text.call(null, a, null);
};
parinfer_lib.infer.process_text.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = cljs.core.merge.call(null, parinfer_lib.infer.initial_state, b), d = parinfer_lib.string.get_lines.call(null, a), c = cljs.core.reduce.call(null, parinfer_lib.infer.process_line, c, d);
  return parinfer_lib.infer.finalize_state.call(null, c);
};
parinfer_lib.infer.process_text.cljs$lang$maxFixedArity = 2;
parinfer_lib.infer.safe_subvec = function(a, b) {
  return b < cljs.core.count.call(null, a) ? cljs.core.subvec.call(null, a, b) : cljs.core.PersistentVector.EMPTY;
};
parinfer_lib.infer.restore_insert_line = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "insert", "insert", 1286475395)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), d = null != b && (b.cljs$lang$protocol_mask$partition0$ & 64 || b.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, b = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486)), d = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "line", "line", 
  212345235));
  return cljs.core.truth_(cljs.core.truth_(b) ? cljs.core.truth_(d) ? 0 <= c : d : b) ? (c = b + c, cljs.core.assoc_in.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "lines", "lines", -700165781), c], null), d)) : a;
};
parinfer_lib.infer.fill_rest_with_cache = function(a, b, c) {
  a = cljs.core.merge.call(null, cljs.core.update.call(null, cljs.core.update.call(null, cljs.core.update.call(null, cljs.core.update.call(null, b, new cljs.core.Keyword(null, "lines", "lines", -700165781), cljs.core.pop), new cljs.core.Keyword(null, "lines", "lines", -700165781), cljs.core.into, parinfer_lib.infer.safe_subvec.call(null, (new cljs.core.Keyword(null, "lines", "lines", -700165781)).cljs$core$IFn$_invoke$arity$1(a), c)), new cljs.core.Keyword(null, "postline-states", "postline-states", 
  1667653678), cljs.core.into, parinfer_lib.infer.safe_subvec.call(null, (new cljs.core.Keyword(null, "postline-states", "postline-states", 1667653678)).cljs$core$IFn$_invoke$arity$1(a), c + 1)), new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728), cljs.core.into, parinfer_lib.infer.safe_subvec.call(null, (new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728)).cljs$core$IFn$_invoke$arity$1(a), c + 1)), cljs.core.last.call(null, (new cljs.core.Keyword(null, 
  "postline-states", "postline-states", 1667653678)).cljs$core$IFn$_invoke$arity$1(a)));
  return parinfer_lib.infer.restore_insert_line.call(null, cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466), cljs.core.count.call(null, (new cljs.core.Keyword(null, "lines", "lines", -700165781)).cljs$core$IFn$_invoke$arity$1(a)) - 1));
};
parinfer_lib.infer.process_unchanged_line_STAR_ = function(a, b, c) {
  var d = cljs.core.nth.call(null, c, 0, null), e = cljs.core.nth.call(null, c, 1, null);
  c = cljs.core.nth.call(null, c, 2, null);
  b = parinfer_lib.infer.process_line.call(null, b, e);
  var f = cljs.core.last.call(null, (new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728)).cljs$core$IFn$_invoke$arity$1(b)), e = d + 1 < cljs.core.count.call(null, (new cljs.core.Keyword(null, "lines", "lines", -700165781)).cljs$core$IFn$_invoke$arity$1(a));
  c = cljs.core.truth_(f) ? cljs.core._EQ_.call(null, f, c) : f;
  return cljs.core.truth_(cljs.core.truth_(c) ? e : c) ? cljs.core.reduced.call(null, parinfer_lib.infer.fill_rest_with_cache.call(null, a, b, d)) : b;
};
parinfer_lib.infer.process_unchanged_lines = function(a, b, c) {
  return cljs.core.reduce.call(null, cljs.core.partial.call(null, parinfer_lib.infer.process_unchanged_line_STAR_, a), b, cljs.core.map.call(null, cljs.core.vector, cljs.core.iterate.call(null, cljs.core.inc, c), parinfer_lib.infer.safe_subvec.call(null, (new cljs.core.Keyword(null, "lines", "lines", -700165781)).cljs$core$IFn$_invoke$arity$1(a), c), parinfer_lib.infer.safe_subvec.call(null, (new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728)).cljs$core$IFn$_invoke$arity$1(a), 
  c)));
};
parinfer_lib.infer.initial_cached_state = function(a, b, c) {
  var d = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, e = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "lines", "lines", -700165781));
  a = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "postline-states", "postline-states", 1667653678));
  d = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728));
  e = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null, "lines", "lines", -700165781), cljs.core.subvec.call(null, e, 0, c), new cljs.core.Keyword(null, "postindent-states", "postindent-states", 965093728), cljs.core.subvec.call(null, d, 0, c), new cljs.core.Keyword(null, "postline-states", "postline-states", 1667653678), cljs.core.subvec.call(null, a, 0, c), new cljs.core.Keyword(null, "line-no", "line-no", -666819466), c - 1], null);
  c = cljs.core.get.call(null, a, c - 1);
  return parinfer_lib.infer.restore_insert_line.call(null, cljs.core.merge.call(null, parinfer_lib.infer.initial_state, b, e, c));
};
parinfer_lib.infer.process_text_change = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 2:
      return parinfer_lib.infer.process_text_change.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    case 3:
      return parinfer_lib.infer.process_text_change.cljs$core$IFn$_invoke$arity$3(arguments[0], arguments[1], arguments[2]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.infer.process_text_change.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  return parinfer_lib.infer.process_text_change.call(null, a, b, null);
};
parinfer_lib.infer.process_text_change.cljs$core$IFn$_invoke$arity$3 = function(a, b, c) {
  var d = null != b && (b.cljs$lang$protocol_mask$partition0$ & 64 || b.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b;
  b = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "line-no", "line-no", -666819466));
  d = cljs.core.get.call(null, d, new cljs.core.Keyword(null, "new-line", "new-line", 1060819447));
  b = "number" === typeof b ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [b, b + 1], null) : b;
  var e = cljs.core.nth.call(null, b, 0, null);
  b = cljs.core.nth.call(null, b, 1, null);
  d = "string" === typeof d ? new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [d], null) : d;
  c = parinfer_lib.infer.initial_cached_state.call(null, a, c, e);
  c = cljs.core.reduce.call(null, parinfer_lib.infer.process_line, c, d);
  a = parinfer_lib.infer.process_unchanged_lines.call(null, a, c, b);
  return parinfer_lib.infer.finalize_state.call(null, a);
};
parinfer_lib.infer.process_text_change.cljs$lang$maxFixedArity = 3;
parinfer_lib.infer.format_text = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.infer.format_text.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.infer.format_text.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.infer.format_text.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.infer.format_text.call(null, a, null);
};
parinfer_lib.infer.format_text.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = parinfer_lib.infer.process_text.call(null, a, b), d = cljs.core.truth_((new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(c)) ? clojure.string.join.call(null, "\n", (new cljs.core.Keyword(null, "lines", "lines", -700165781)).cljs$core$IFn$_invoke$arity$1(c)) : a;
  return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "text", "text", -1790561697), d, new cljs.core.Keyword(null, "valid?", "valid?", -212412379), (new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(c), new cljs.core.Keyword(null, "state", "state", -1988618099), c], null);
};
parinfer_lib.infer.format_text.cljs$lang$maxFixedArity = 2;
parinfer_lib.infer.format_text_change = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 3:
      return parinfer_lib.infer.format_text_change.cljs$core$IFn$_invoke$arity$3(arguments[0], arguments[1], arguments[2]);
    case 4:
      return parinfer_lib.infer.format_text_change.cljs$core$IFn$_invoke$arity$4(arguments[0], arguments[1], arguments[2], arguments[3]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.infer.format_text_change.cljs$core$IFn$_invoke$arity$3 = function(a, b, c) {
  return parinfer_lib.infer.format_text_change.call(null, a, b, c, null);
};
parinfer_lib.infer.format_text_change.cljs$core$IFn$_invoke$arity$4 = function(a, b, c, d) {
  b = parinfer_lib.infer.process_text_change.call(null, b, c, d);
  a = cljs.core.truth_((new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(b)) ? clojure.string.join.call(null, "\n", (new cljs.core.Keyword(null, "lines", "lines", -700165781)).cljs$core$IFn$_invoke$arity$1(b)) : a;
  return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "text", "text", -1790561697), a, new cljs.core.Keyword(null, "valid?", "valid?", -212412379), (new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(b), new cljs.core.Keyword(null, "state", "state", -1988618099), b], null);
};
parinfer_lib.infer.format_text_change.cljs$lang$maxFixedArity = 4;
parinfer_lib.prep = {};
parinfer_lib.prep.initial_state = cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null, "backup", "backup", 26347393), new cljs.core.Keyword(null, "insert", "insert", 1286475395), new cljs.core.Keyword(null, "dedent-x", "dedent-x", 1097411627), new cljs.core.Keyword(null, "lines", "lines", -700165781), new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136), new cljs.core.Keyword(null, "line-no", "line-no", -666819466), new cljs.core.Keyword(null, "stack", "stack", 
-793405930), new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762), new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232)], [cljs.core.PersistentVector.EMPTY, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486), null, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), null], null), null, cljs.core.PersistentVector.EMPTY, !1, -1, cljs.core.PersistentVector.EMPTY, new cljs.core.PersistentArrayMap(null, 2, 
[new cljs.core.Keyword(null, "start", "start", -355208981), null, new cljs.core.Keyword(null, "end", "end", -268185958), null], null), 0]);
parinfer_lib.prep.append_delim_trail = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), d = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "insert", "insert", 1286475395)), e = cljs.core.peek.call(null, b), f = parinfer_lib.reader.matching_delim.call(null, (new cljs.core.Keyword(null, "ch", "ch", -554717905)).cljs$core$IFn$_invoke$arity$1(e)), b = cljs.core.pop.call(null, b);
  return cljs.core.update_in.call(null, cljs.core.update_in.call(null, cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930), b, new cljs.core.Keyword(null, "dedent-x", "dedent-x", 1097411627), (new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)).cljs$core$IFn$_invoke$arity$1(e)), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "lines", "lines", -700165781), c + (new cljs.core.Keyword(null, "line-dy", 
  "line-dy", 41667486)).cljs$core$IFn$_invoke$arity$1(d)], null), parinfer_lib.string.insert_string, (new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)).cljs$core$IFn$_invoke$arity$1(d), f), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "insert", "insert", 1286475395), new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)], null), cljs.core.inc);
};
parinfer_lib.prep.min_indent = function(a, b) {
  var c = null != b && (b.cljs$lang$protocol_mask$partition0$ & 64 || b.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, c = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "stack", "stack", -793405930)), c = cljs.core.peek.call(null, c), c = (new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)).cljs$core$IFn$_invoke$arity$1(c);
  return cljs.core.truth_(c) ? (c += 1, c > a ? c : a) : a;
};
parinfer_lib.prep.min_dedent = function(a, b) {
  var c = null != b && (b.cljs$lang$protocol_mask$partition0$ & 64 || b.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, c = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "dedent-x", "dedent-x", 1097411627));
  return cljs.core.truth_(c) ? c < a ? c : a : a;
};
parinfer_lib.prep.correct_indent = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)), d = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930));
  cljs.core.get.call(null, a, new cljs.core.Keyword(null, "dedent-x", "dedent-x", 1097411627));
  var e = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), d = cljs.core.peek.call(null, d), d = (new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232)).cljs$core$IFn$_invoke$arity$2(d, 0), d = parinfer_lib.prep.min_dedent.call(null, parinfer_lib.prep.min_indent.call(null, c + d, a), a), b = b + (d - c), c = cljs.core.apply.call(null, cljs.core.str, cljs.core.repeat.call(null, d, " "));
  return cljs.core.assoc.call(null, cljs.core.assoc_in.call(null, a, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "lines", "lines", -700165781), e], null), c), new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232), b, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), d, new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136), !1, new cljs.core.Keyword(null, "dedent-x", "dedent-x", 1097411627), 
  null);
};
parinfer_lib.prep.handle_cursor_delta = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  cljs.core.get.call(null, a, new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232));
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), c = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783)), d = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "cursor-line", "cursor-line", -1089611007)), e = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "cursor-x", "cursor-x", 475204266)), f = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "cursor-dx", "cursor-dx", 133069327));
  c = (b = cljs.core._EQ_.call(null, d, b)) ? (c = cljs.core._EQ_.call(null, e, c)) ? f : c : b;
  return cljs.core.truth_(c) ? cljs.core.update.call(null, a, new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232), cljs.core._PLUS_, f) : a;
};
parinfer_lib.prep.process_indent = function(a) {
  var b = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "stack", "stack", -793405930)), d = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "lines", "lines", -700165781));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "line-no", "line-no", -666819466));
  var e = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "ch", "ch", -554717905));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "cursor-line", "cursor-line", -1089611007));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "cursor-x", "cursor-x", 475204266));
  cljs.core.get.call(null, b, new cljs.core.Keyword(null, "cursor-dx", "cursor-dx", 133069327));
  var f = function() {
    if (cljs.core.truth_(d)) {
      var a = parinfer_lib.reader.in_code_QMARK_.call(null, c);
      return cljs.core.truth_(a) ? cljs.core.not.call(null, parinfer_lib.reader.whitespace_QMARK_.call(null, e)) && cljs.core.not_EQ_.call(null, ";", e) : a;
    }
    return d;
  }(), g = function() {
    if (cljs.core.truth_(f)) {
      var a = parinfer_lib.reader.closing_delim_QMARK_.call(null, e);
      return cljs.core.truth_(a) ? parinfer_lib.reader.valid_closer_QMARK_.call(null, c, e) : a;
    }
    return f;
  }(), h = cljs.core.truth_(f) ? parinfer_lib.reader.closing_delim_QMARK_.call(null, e) : f;
  a = cljs.core.truth_(f) ? cljs.core.not.call(null, h) : f;
  b = cljs.core.assoc.call(null, b, new cljs.core.Keyword(null, "process?", "process?", -106844121), cljs.core.not.call(null, h));
  g = cljs.core.truth_(g) ? parinfer_lib.prep.append_delim_trail.call(null, b) : b;
  g = parinfer_lib.prep.handle_cursor_delta.call(null, g);
  return cljs.core.truth_(a) ? parinfer_lib.prep.correct_indent.call(null, g) : g;
};
parinfer_lib.prep.process_char = function(a, b) {
  var c = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "lines", "lines", -700165781)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), d = cljs.core.count.call(null, cljs.core.get.call(null, d, e)), c = cljs.core.assoc.call(null, c, new cljs.core.Keyword(null, "x-pos", "x-pos", -382213783), d, new cljs.core.Keyword(null, 
  "ch", "ch", -554717905), "" + cljs.core.str(b)), c = parinfer_lib.prep.process_indent.call(null, c);
  return cljs.core.truth_((new cljs.core.Keyword(null, "process?", "process?", -106844121)).cljs$core$IFn$_invoke$arity$1(c)) ? parinfer_lib.infer.process_char_STAR_.call(null, c) : c;
};
parinfer_lib.prep.reinsert_delims = function(a) {
  var b = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "removed-delims", "removed-delims", 137127226));
  return cljs.core.reduce.call(null, function(a, b, c, g) {
    return function(a, b) {
      return parinfer_lib.prep.append_delim_trail.call(null, a);
    };
  }(a, b, b, c), b, c);
};
parinfer_lib.prep.process_line = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.prep.process_line.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.prep.process_line.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.prep.process_line.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.prep.process_line.call(null, parinfer_lib.prep.initial_state, a);
};
parinfer_lib.prep.process_line.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "stack", "stack", -793405930)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "lines", "lines", -700165781)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "line-no", "line-no", -666819466)), g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "cursor-line", 
  "cursor-line", -1089611007)), h = f + 1, k = cljs.core.assoc.call(null, c, new cljs.core.Keyword(null, "backup", "backup", 26347393), cljs.core.PersistentVector.EMPTY, new cljs.core.Keyword(null, "cursor-in-comment?", "cursor-in-comment?", 1676951135), !1, new cljs.core.Keyword(null, "delim-trail", "delim-trail", -1171858762), new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "start", "start", -355208981), null, new cljs.core.Keyword(null, "end", "end", -268185958), null], 
  null), new cljs.core.Keyword(null, "track-indent?", "track-indent?", -1967553136), cljs.core.not.call(null, parinfer_lib.reader.in_str_QMARK_.call(null, d)), new cljs.core.Keyword(null, "indent-delta", "indent-delta", -1753368232), 0, new cljs.core.Keyword(null, "lines", "lines", -700165781), cljs.core.conj.call(null, e, ""), new cljs.core.Keyword(null, "line-no", "line-no", -666819466), h, new cljs.core.Keyword(null, "removed-delims", "removed-delims", 137127226), cljs.core.PersistentVector.EMPTY), 
  c = cljs.core.update_in.call(null, k, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "insert", "insert", 1286475395), new cljs.core.Keyword(null, "line-dy", "line-dy", 41667486)], null), function(a, b, c, d, e, f, g, h, k) {
    return function(a) {
      return cljs.core.truth_(a) ? a - 1 : null;
    };
  }(h, k, a, c, c, d, e, f, g)), c = cljs.core.reduce.call(null, parinfer_lib.prep.process_char, c, [cljs.core.str(b), cljs.core.str("\n")].join(""));
  return parinfer_lib.prep.reinsert_delims.call(null, parinfer_lib.infer.remove_delim_trail.call(null, c));
};
parinfer_lib.prep.process_line.cljs$lang$maxFixedArity = 2;
parinfer_lib.prep.finalize_state = function(a) {
  a = null != a && (a.cljs$lang$protocol_mask$partition0$ & 64 || a.cljs$core$ISeq$) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "stack", "stack", -793405930)), b = cljs.core.empty_QMARK_.call(null, b);
  return cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "valid?", "valid?", -212412379), b);
};
parinfer_lib.prep.process_text = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.prep.process_text.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.prep.process_text.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.prep.process_text.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.prep.process_text.call(null, a, null);
};
parinfer_lib.prep.process_text.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = cljs.core.merge.call(null, parinfer_lib.prep.initial_state, b), d = parinfer_lib.string.get_lines.call(null, a), c = cljs.core.reduce.call(null, parinfer_lib.prep.process_line, c, d);
  return parinfer_lib.prep.finalize_state.call(null, c);
};
parinfer_lib.prep.process_text.cljs$lang$maxFixedArity = 2;
parinfer_lib.prep.format_text = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.prep.format_text.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.prep.format_text.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.prep.format_text.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.prep.format_text.call(null, a, null);
};
parinfer_lib.prep.format_text.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = parinfer_lib.prep.process_text.call(null, a, b), d = cljs.core.truth_((new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(c)) ? clojure.string.join.call(null, "\n", (new cljs.core.Keyword(null, "lines", "lines", -700165781)).cljs$core$IFn$_invoke$arity$1(c)) : a;
  return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "text", "text", -1790561697), d, new cljs.core.Keyword(null, "valid?", "valid?", -212412379), (new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(c), new cljs.core.Keyword(null, "state", "state", -1988618099), c], null);
};
parinfer_lib.prep.format_text.cljs$lang$maxFixedArity = 2;
cljs.nodejs = {};
...
parinfer_lib.js_exports = {};
parinfer_lib.js_exports.js_infer_parens = function(a, b) {
  var c = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "cursor-line", "cursor-line", -1089611007), b.row, new cljs.core.Keyword(null, "cursor-x", "cursor-x", 475204266), b.column], null), c = parinfer_lib.infer.format_text.call(null, a, c);
  return cljs.core.truth_((new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(c)) ? (new cljs.core.Keyword(null, "text", "text", -1790561697)).cljs$core$IFn$_invoke$arity$1(c) : !1;
};
parinfer_lib.js_exports.js_format_indentation = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return parinfer_lib.js_exports.js_format_indentation.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return parinfer_lib.js_exports.js_format_indentation.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
parinfer_lib.js_exports.js_format_indentation.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return parinfer_lib.js_exports.js_format_indentation.call(null, a, null);
};
parinfer_lib.js_exports.js_format_indentation.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = cljs.core.truth_(b) ? new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "cursor-line", "cursor-line", -1089611007), b.row, new cljs.core.Keyword(null, "cursor-x", "cursor-x", 475204266), b.column], null) : cljs.core.PersistentArrayMap.EMPTY, c = parinfer_lib.prep.format_text.call(null, a, c);
  return cljs.core.truth_((new cljs.core.Keyword(null, "valid?", "valid?", -212412379)).cljs$core$IFn$_invoke$arity$1(c)) ? (new cljs.core.Keyword(null, "text", "text", -1790561697)).cljs$core$IFn$_invoke$arity$1(c) : !1;
};
parinfer_lib.js_exports.js_format_indentation.cljs$lang$maxFixedArity = 2;
cljs.core.truth_(module) && (module.exports = function() {
  return {inferParens:parinfer_lib.js_exports.js_infer_parens, setIndentation:parinfer_lib.js_exports.js_format_indentation};
}());
