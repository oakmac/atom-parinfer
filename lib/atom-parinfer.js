...
atom_parinfer.core.get_active_editor_id = function() {
  ...
  return cljs.core.truth_(a.id) ? a.id : !1;
};
...
atom_parinfer.core.link_text = function(a) {
  return cljs.core._EQ_.call(null, a, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542)) ? "Indent Mode" : cljs.core._EQ_.call(null, a, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) ? "Paren Mode" : "";
};
...
atom_parinfer.core.apply_parinfer_STAR_ = function(a, b) {
  return atom_parinfer.util.js_log.call(null, [cljs.core.str(cljs.core.name.call(null, b)), cljs.core.str(" "), cljs.core.str(cljs.core.rand_int.call(null, 10))].join(""));
};
...
atom_parinfer.core.file_has_watched_extension_QMARK_ = function(a) {
  ...
  return b ? cljs.core.some.call(null, function(b) {
    return function(b) {
      return atom_parinfer.util.ends_with.call(null, a, b);
    };
...
atom_parinfer.core.hello_editor = function(a) {
  var b = a.id;
  atom_parinfer.core.file_has_watched_extension_QMARK_.call(null, a.getPath());
