...
atom_parinfer.core.apply_parinfer_STAR_ = function(a, b) {
  ...
  d)), cljs.core.str("\n")].join(""), h = cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) ? atom_parinfer.core.parinfer.parenMode.call(null, d, h) : atom_parinfer.core.parinfer.indentMode.call(null, d, h), e = {column:h.cursorX, row:e.row}, k = !0 === h.success, h = k ? h.text : !1;
  "string" === typeof h && cljs.core.not_EQ_.call(null, h, d) && (a.setTextInBufferRange([[f, 0], [g, 0]], h, {undo:"skip"}), a.setCursorBufferPosition(e), a.setSelectedBufferRanges(c));
