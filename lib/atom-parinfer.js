...
cljs.core.nil_iter = function cljs$core$nil_iter() {
  "undefined" === typeof cljs.core.t_cljs$core7781 && (cljs.core.t_cljs$core7781 = function(b, c) {
    this.nil_iter = b;
    this.meta7782 = c;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
    this.cljs$lang$protocol_mask$partition1$ = 0;
  }, cljs.core.t_cljs$core7781.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t_cljs$core7781(this.nil_iter, c);
  }, cljs.core.t_cljs$core7781.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta7782;
  }, cljs.core.t_cljs$core7781.prototype.hasNext = function() {
    return !1;
  }, cljs.core.t_cljs$core7781.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t_cljs$core7781.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t_cljs$core7781.getBasis = function() {
    return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null, "nil-iter", "nil-iter", 1101030523, null), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "arglists", "arglists", 1661989754), cljs.core.list(new cljs.core.Symbol(null, "quote", "quote", 1377916282, null), cljs.core.list(cljs.core.PersistentVector.EMPTY))], null)), new cljs.core.Symbol(null, "meta7782", "meta7782", 920326427, null)], 
    null);
  }, cljs.core.t_cljs$core7781.cljs$lang$type = !0, cljs.core.t_cljs$core7781.cljs$lang$ctorStr = "cljs.core/t_cljs$core7781", cljs.core.t_cljs$core7781.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write(c, "cljs.core/t_cljs$core7781");
  }, cljs.core.__GT_t_cljs$core7781 = function(b, c) {
    return new cljs.core.t_cljs$core7781(b, c);
  });
  return new cljs.core.t_cljs$core7781(cljs$core$nil_iter, cljs.core.PersistentArrayMap.EMPTY);
};
...
atom_parinfer.util.ends_with = function(a, b) {
  var c = a.substring(a.length - b.length);
  return cljs.core._EQ_.call(null, c, b);
};
var clojure = {string:{}};
...
atom_parinfer.core.underscore = require("underscore");
...
atom_parinfer.core.default_file_extensions = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [".cljc", null, ".lfe", null, ".cljs", null, ".clj", null], null), null);
atom_parinfer.core.default_file_extension_config = [cljs.core.str("# one file extension per line please :)\n"), cljs.core.str(clojure.string.join.call(null, "\n", cljs.core.sort.call(null, atom_parinfer.core.default_file_extensions)))].join("");
...
atom_parinfer.core.valid_states = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "disabled", "disabled", -1529784218), null, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542), null, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645), null], null), null);
atom_parinfer.core.current_state = cljs.core.atom.call(null, new cljs.core.Keyword(null, "disabled", "disabled", -1529784218));
cljs.core.set_validator_BANG_.call(null, atom_parinfer.core.current_state, function(a) {
  return cljs.core.contains_QMARK_.call(null, atom_parinfer.core.valid_states, a);
});
...
atom_parinfer.core.update_status_bar_BANG_ = function(a, b, c, d) {
  return cljs.core._EQ_.call(null, d, new cljs.core.Keyword(null, "disabled", "disabled", -1529784218)) ? atom_parinfer.core.remove_status_el_BANG_.call(null) : cljs.core.doall.call(null, cljs.core.truth_(atom_parinfer.util.by_id.call(null, atom_parinfer.core.status_el_id)) ? null : atom_parinfer.core.inject_status_el_into_dom_BANG_.call(null), function() {
    var a = atom_parinfer.util.by_id.call(null, atom_parinfer.core.status_el_id);
    return cljs.core.truth_(a) ? a.innerHTML = cljs.core.name.call(null, d) : null;
  }());
};
cljs.core.add_watch.call(null, atom_parinfer.core.current_state, new cljs.core.Keyword(null, "status-bar", "status-bar", -675531118), atom_parinfer.core.update_status_bar_BANG_);
atom_parinfer.core.editors = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
atom_parinfer.core.apply_parinfer_BANG_ = function(a) {
  atom.workspace.getActiveTextEditor();
  return null;
};
atom_parinfer.core.goodbye_editor = function(a) {
  return cljs.core.truth_(cljs.core.truth_(a) ? a.id : a) ? cljs.core.swap_BANG_.call(null, atom_parinfer.core.editors, cljs.core.dissoc, a.id) : null;
};
atom_parinfer.core.debounce_interval_ms = 10;
atom_parinfer.core.hello_editor = function(a) {
  var b = a.id;
  a.getPath();
  var c = atom_parinfer.core.underscore.debounce(atom_parinfer.core.apply_parinfer_BANG_, atom_parinfer.core.debounce_interval_ms);
  cljs.core.swap_BANG_.call(null, atom_parinfer.core.editors, cljs.core.assoc, b, cljs.core.PersistentArrayMap.EMPTY);
  a.onDidChangeSelectionRange(c);
  return a.onDidDestroy(atom_parinfer.core.goodbye_editor);
};
...
atom_parinfer.core.disable_BANG_ = function() {
  return cljs.core.reset_BANG_.call(null, atom_parinfer.core.current_state, new cljs.core.Keyword(null, "disabled", "disabled", -1529784218));
};
atom_parinfer.core.toggle_BANG_ = function() {
  return cljs.core._EQ_.call(null, cljs.core.deref.call(null, atom_parinfer.core.current_state), new cljs.core.Keyword(null, "disabled", "disabled", -1529784218)) ? cljs.core.reset_BANG_.call(null, atom_parinfer.core.current_state, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542)) : cljs.core._EQ_.call(null, cljs.core.deref.call(null, atom_parinfer.core.current_state), new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542)) ? cljs.core.reset_BANG_.call(null, atom_parinfer.core.current_state, 
  new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) : cljs.core.reset_BANG_.call(null, atom_parinfer.core.current_state, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542));
};
atom_parinfer.core.activate = function(a) {
  ...
  return atom.commands.add("atom-workspace", {"parinfer:editFileExtensions":atom_parinfer.core.edit_file_extensions_BANG_, "parinfer:disable":atom_parinfer.core.disable_BANG_, "parinfer:toggleMode":atom_parinfer.core.toggle_BANG_});
};
atom_parinfer.core.deactivate = function() {
  return null;
};
atom_parinfer.core.always_nil = cljs.core.constantly.call(null, null);
module.exports = function() {
  return {activate:atom_parinfer.core.activate, deactivate:atom_parinfer.core.deactivate, serialize:atom_parinfer.core.always_nil};
}();
cljs.core._STAR_main_cli_fn_STAR_ = atom_parinfer.core.always_nil;
cljs.nodejs = {};
