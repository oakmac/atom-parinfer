...
var subscriptions = null,
    fileExtensionsToWatch = null;

const debounceIntervalMs = 20;
...
// TODO: how to handle parinfer when there are multiple cursors?
...
function newTextEditorOpened(editor) {
  ...
  if (typeof filePath !== 'string' ||
      fileMatchesWatchedExtensions(filePath) !== true) return;
