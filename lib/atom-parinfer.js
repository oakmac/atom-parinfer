...
atom_parinfer.core.apply_parinfer_STAR_ = function(a, b) {
  ...
  d = cljs.core.subvec.call(null, d, g, h), d = [cljs.core.str(clojure.string.join.call(null, "\n", d)), cljs.core.str("\n")].join(""), k = cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) ? atom_parinfer.core.parinfer.parenMode.call(null, d, k) : atom_parinfer.core.parinfer.indentMode.call(null, d, k), f = {column:k.cursorX, row:f.row}, l = !0 === k.success, k = l ? k.text : !1;
