...
cljs.core.nil_iter = function cljs$core$nil_iter() {
  "undefined" === typeof cljs.core.t_cljs$core7838 && (cljs.core.t_cljs$core7838 = function(b, c) {
    this.nil_iter = b;
    this.meta7839 = c;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
    this.cljs$lang$protocol_mask$partition1$ = 0;
  }, cljs.core.t_cljs$core7838.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t_cljs$core7838(this.nil_iter, c);
  }, cljs.core.t_cljs$core7838.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta7839;
  }, cljs.core.t_cljs$core7838.prototype.hasNext = function() {
    return !1;
  }, cljs.core.t_cljs$core7838.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t_cljs$core7838.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t_cljs$core7838.getBasis = function() {
    return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null, "nil-iter", "nil-iter", 1101030523, null), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "arglists", "arglists", 1661989754), cljs.core.list(new cljs.core.Symbol(null, "quote", "quote", 1377916282, null), cljs.core.list(cljs.core.PersistentVector.EMPTY))], null)), new cljs.core.Symbol(null, "meta7839", "meta7839", -1795121072, null)], 
    null);
  }, cljs.core.t_cljs$core7838.cljs$lang$type = !0, cljs.core.t_cljs$core7838.cljs$lang$ctorStr = "cljs.core/t_cljs$core7838", cljs.core.t_cljs$core7838.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write(c, "cljs.core/t_cljs$core7838");
  }, cljs.core.__GT_t_cljs$core7838 = function(b, c) {
    return new cljs.core.t_cljs$core7838(b, c);
  });
  return new cljs.core.t_cljs$core7838(cljs$core$nil_iter, cljs.core.PersistentArrayMap.EMPTY);
};
...
atom_parinfer.util.lines_diff = function(a, b) {
  var c = clojure.string.split_lines.call(null, a), d = clojure.string.split_lines.call(null, b), e = cljs.core.map.call(null, cljs.core.vector, c, d), f = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "diff", "diff", 2135942783), 0, new cljs.core.Keyword(null, "same", "same", 1087905061), 0], null);
...
var lowline = {functions:{}};
lowline.functions.debounce = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  switch(b.length) {
    case 1:
      return lowline.functions.debounce.cljs$core$IFn$_invoke$arity$1(arguments[0]);
    case 2:
      return lowline.functions.debounce.cljs$core$IFn$_invoke$arity$2(arguments[0], arguments[1]);
    default:
      throw Error([cljs.core.str("Invalid arity: "), cljs.core.str(b.length)].join(""));;
  }
};
lowline.functions.debounce.cljs$core$IFn$_invoke$arity$1 = function(a) {
  return lowline.functions.debounce.call(null, a, 1E3);
};
lowline.functions.debounce.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  return function(c) {
    return function(d) {
      clearTimeout(cljs.core.deref.call(null, c));
      return cljs.core.reset_BANG_.call(null, c, setTimeout(cljs.core.partial.call(null, a, d), b));
    };
  }(cljs.core.atom.call(null, null));
};
lowline.functions.debounce.cljs$lang$maxFixedArity = 2;
cljs.nodejs = {};
...
atom_parinfer.core = {};
atom_parinfer.core.load_file_extensions_BANG_;
atom_parinfer.core.toggle_mode_BANG_;
...
atom_parinfer.core.SimpleCache = require("simple-lru-cache");
...
atom_parinfer.core.default_file_extensions = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 5, [".cljc", null, ".rkt", null, ".lfe", null, ".cljs", null, ".clj", null], null), null);
...
atom_parinfer.core.parse_file_extension_config = function(a) {
  a = clojure.string.split_lines.call(null, a);
...
atom_parinfer.core.write_default_file_extensions_config_BANG_ = function() {
  return atom_parinfer.core.fs.writeFile.call(null, atom_parinfer.core.file_extension_file, atom_parinfer.core.default_file_extension_config, function(a) {
    return cljs.core.truth_(a) ? cljs.core.List.EMPTY : atom_parinfer.core.load_file_extensions_BANG_.call(null);
  });
};
atom_parinfer.core.load_file_extensions_callback = function(a, b) {
  return cljs.core.truth_(a) ? atom_parinfer.core.write_default_file_extensions_config_BANG_.call(null) : cljs.core.reset_BANG_.call(null, atom_parinfer.core.file_extensions, atom_parinfer.core.parse_file_extension_config.call(null, b));
};
atom_parinfer.core.load_file_extensions_BANG_ = function() {
  return atom_parinfer.core.fs.readFile.call(null, atom_parinfer.core.file_extension_file, atom_parinfer.core.utf8, atom_parinfer.core.load_file_extensions_callback);
};
...
atom_parinfer.core.lru_cache_size = 100;
atom_parinfer.core.indent_mode_cache = new atom_parinfer.core.SimpleCache(function() {
  return {maxSize:atom_parinfer.core.lru_cache_size};
}());
atom_parinfer.core.paren_mode_cache = new atom_parinfer.core.SimpleCache(function() {
  return {maxSize:atom_parinfer.core.lru_cache_size};
}());
...
atom_parinfer.core.find_start_row = function(a, b) {
  ...
  for (var c = b - 1;;) {
    if (cljs.core.truth_(function() {
      var b = 0 === c;
      return b ? b : atom_parinfer.core.is_parent_expression_line_QMARK_.call(null, cljs.core.nth.call(null, a, c));
    }())) {
      return c;
    }
    --c;
...
atom_parinfer.core.find_end_row = function(a, b) {
  ...
  for (var d = b + 1;;) {
    if (cljs.core.truth_(function() {
      var b = d === c;
      return b ? b : atom_parinfer.core.is_parent_expression_line_QMARK_.call(null, cljs.core.nth.call(null, a, d));
    }())) {
      return d;
    }
    d += 1;
...
atom_parinfer.core.apply_parinfer_STAR_ = function(a, b) {
  var c = a.getText(), c = cljs.core.into.call(null, cljs.core.PersistentVector.EMPTY, c.split("\n")), d = cljs.core._EQ_.call(null, "", cljs.core.peek.call(null, c)) ? c : cljs.core.conj.call(null, c, ""), c = a.getCursorBufferPosition(), e = a.getSelectedBufferRanges(), f = atom_parinfer.core.find_start_row.call(null, d, c.row), g = atom_parinfer.core.find_end_row.call(null, d, c.row), h = {cursorLine:c.row - f, cursorX:c.column}, d = cljs.core.subvec.call(null, d, f, g), d = [cljs.core.str(clojure.string.join.call(null, 
  "\n", d)), cljs.core.str("\n")].join(""), k = cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) ? atom_parinfer.core.parinfer.parenMode : atom_parinfer.core.parinfer.indentMode, l = cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) ? atom_parinfer.core.paren_mode_cache.get(d) : atom_parinfer.core.indent_mode_cache.get(d), h = cljs.core.truth_(l) ? l : k.call(null, d, h), m = (k = !0 === h.success) ? 
  h.text : !1;
  cljs.core.truth_(l) || (cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) ? atom_parinfer.core.paren_mode_cache.set(d, h) : atom_parinfer.core.indent_mode_cache.set(d, h));
  "string" === typeof m && cljs.core.not_EQ_.call(null, m, d) && (a.setTextInBufferRange([[f, 0], [g, 0]], m, {undo:"skip"}), a.setCursorBufferPosition(c), a.setSelectedBufferRanges(e));
  return cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) && !k ? atom_parinfer.core.set_status_bar_warning_BANG_.call(null) : atom_parinfer.core.clear_status_bar_warning_BANG_.call(null);
};
atom_parinfer.core.apply_parinfer_BANG_ = function(a) {
  ...
  return cljs.core.truth_(function() {
    ...
    return b;
  }()) ? cljs.core._EQ_.call(null, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542), cljs.core.get.call(null, cljs.core.deref.call(null, atom_parinfer.core.editor_states), b.id)) ? atom_parinfer.core.apply_parinfer_STAR_.call(null, b, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542)) : cljs.core._EQ_.call(null, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645), cljs.core.get.call(null, cljs.core.deref.call(null, atom_parinfer.core.editor_states), 
  b.id)) ? atom_parinfer.core.apply_parinfer_STAR_.call(null, b, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645)) : null : null;
};
atom_parinfer.core.debounce_interval_ms = 10;
atom_parinfer.core.debounced_apply_parinfer = lowline.functions.debounce.call(null, atom_parinfer.core.apply_parinfer_BANG_, atom_parinfer.core.debounce_interval_ms);
...
atom_parinfer.core.hello_editor = function(a) {
  ...
  if (cljs.core.truth_(c)) {
    var e = a.getText(), f = atom_parinfer.core.parinfer.parenMode.call(null, e), g = !0 === f.success, h = f.text, k = atom_parinfer.util.lines_diff.call(null, e, h), l = g && 0 !== (new cljs.core.Keyword(null, "diff", "diff", 2135942783)).cljs$core$IFn$_invoke$arity$1(k);
    return g ? l ? atom.confirm(function() {
      return {message:[cljs.core.str("Parinfer will change "), cljs.core.str(d)].join(""), detailedMessage:atom_parinfer.core.confirm_paren_mode_msg.call(null, d, (new cljs.core.Keyword(null, "diff", "diff", 2135942783)).cljs$core$IFn$_invoke$arity$1(k)), buttons:function() {
        return {Yes:function(b, c, d, e, f, g, h, k, l) {
          return function() {
            a.setText(e);
            return cljs.core.swap_BANG_.call(null, atom_parinfer.core.editor_states, cljs.core.assoc, h, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542));
          };
        }(e, f, g, h, k, l, b, c, d), No:atom_parinfer.util.always_nil};
      }()};
    }()) : cljs.core.swap_BANG_.call(null, atom_parinfer.core.editor_states, cljs.core.assoc, b, new cljs.core.Keyword(null, "indent-mode", "indent-mode", 1737814542)) : atom.confirm(function() {
      return {message:[cljs.core.str(d), cljs.core.str(" has unbalanced parens")].join(""), detailedMessage:atom_parinfer.core.paren_mode_failed_msg.call(null, d), buttons:function() {
        return {Ok:function(a, b, c, d, e, f, g, h, k) {
          return function() {
            return cljs.core.swap_BANG_.call(null, atom_parinfer.core.editor_states, cljs.core.assoc, g, new cljs.core.Keyword(null, "paren-mode", "paren-mode", -2068924645));
          };
        }(e, f, g, h, k, l, b, c, d)};
      }()};
    }());
...
atom_parinfer.core.activate = function(a) {
  atom_parinfer.util.js_log.call(null, [cljs.core.str("atom-parinfer "), cljs.core.str(atom_parinfer.core.version), cljs.core.str(" activated")].join(""));
